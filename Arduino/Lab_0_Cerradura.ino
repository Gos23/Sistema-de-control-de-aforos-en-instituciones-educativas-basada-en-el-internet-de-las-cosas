...
const String Lab_Aula = "Laboratorio de Sistemas Digitales"; // Laboratorio o aula equipada donde se encuentra la cerradura.
        ...
        if(key == '#'){                 // Si el usuario teclea "#", quiere decir que ya ah acabado de poner su contrasena.
          ...
          String codigo = String(num1); //En num1 se guarda el codigo tecleado por el usuario, lo convertimos a string.
           ...
           if(codigo == "1903152172"){
            ...
            client.publish("Gabanni/UAMazc/compararteclado/Profesor/0", out); //Publicamos en MQTT.
...
void Fun_RFID() {
    ...
    if(uid != -1){                    // Comprobamos que la lectura de la tarjeta sea correcta 
      ...
      client.publish("Gabanni/UAMazc/compararRFID/Alumno/0", out); //Publicamos en MQTT.
    }
}
...
// Convertimos la imagen de la huella presentada codigo para compararla.
  ...
  client.publish("Gabanni/UAMazc/compararHuella/Profesor/0", out); //Publicamos en MQTT. 
...
void EstadoPuerta() {
    ...
    char out[128];
    int b = serializeJson(doc, out);           //Sereliarizamos el JSON para poderlo mandar por mqtt.  
    client.publish("Gabanni/UAMazc/EstadoPuerta/0", out); //Publicamos
}
...
void callback(char* topic, byte* message, unsigned int length) {
    ...
    if (String(topic) == "Gabanni/UAMazc/Apertura/0") {
    ...
    if (String(topic) == "Gabanni/UAMazc/Bloqueo/0") {
  ...
  if (String(topic) == "Gabanni/UAMazc/SinAcceso/0") {
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      display.setCursor(0, 0);
  ...
  // Funcion para indicar al usuario que el metdo de acceso fue incorrecto.
  if (String(topic) == "Gabanni/UAMazc/Ocupado/0") {
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      display.setCursor(0, 0);
  ...
  if (String(topic) == "Gabanni/UAMazc/AforoLleno/0") {
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      display.setCursor(0, 0);
  ...
  if (String(topic) == "Gabanni/UAMazc/TemperaturaAlta/0") {
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      display.setCursor(0, 0);
  ...
  // Funcion para indicar al usuario que el metdo de acceso fue incorrecto.
  if (String(topic) == "Gabanni/UAMazc/Despedida/0") {
  ...
  if (String(topic) == "Gabanni/UAMazc/DeshabilitadoTemperatura/Alumno/0") {
      // Mesnaje de identifacion.
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      ...
      char out[128];
      int b = serializeJson(doc, out);  //Sereliarizamos el JSON para poderlo mandar por mqtt.       
      client.publish("Gabanni/UAMazc/InfoDeshabilitadoTemperatura/Alumno/0", out); //Publicamos en MQTT.
  }

  if (String(topic) == "Gabanni/UAMazc/DeshabilitadoTemperatura/Profesor/0") {
      // Mesnaje de identifacion.
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      ...
      char out[128];
      int b = serializeJson(doc, out);  //Sereliarizamos el JSON para poderlo mandar por mqtt.       
      client.publish("Gabanni/UAMazc/InfoDeshabilitadoTemperatura/Profesor/0", out); //Publicamos en MQTT.
  }

  // Funcion para la lectura de temperatura coorporal para alumnos.
  if (String(topic) == "Gabanni/UAMazc/LecturaTemperatura/Alumno/0") {
      // Mesnaje de identifacion.
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      ...
      while(i == true){ // Bucle para la lectura de la temperatura coorporal.
        ...
        switch(Presente){
          ...
          char out[128];
          int b = serializeJson(doc, out);  //Sereliarizamos el JSON para poderlo mandar por mqtt.       
          client.publish("Gabanni/UAMazc/InfoTemperatura/Alumno/0", out); //Publicamos en MQTT.
          break;
        }
      } 
  }
  ...
  // Funcion para la lectura de temperatura coorporal para alumnos.
  if (String(topic) == "Gabanni/UAMazc/LecturaTemperatura/Profesor/0") {
      // Mesnaje de identifacion.
      display.clearDisplay();
      display.setTextColor(WHITE);
      display.setTextSize(2);
      ...
      while(i == true){ // Bucle para la lectura de la temperatura coorporal.
        ...
        switch(Presente){
          ...
          char out[128];
          int b = serializeJson(doc, out);  //Sereliarizamos el JSON para poderlo mandar por mqtt.       
          client.publish("Gabanni/UAMazc/InfoTemperatura/Profesor/0", out); //Publicamos en MQTT. 
          break;
        }
      } 
  }
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("ESP32Client0")) {
      ...
      client.subscribe("Gabanni/UAMazc/Ocupado/0");
      client.subscribe("Gabanni/UAMazc/Bloqueo/0");
      client.subscribe("Gabanni/UAMazc/Apertura/0");
      client.subscribe("Gabanni/UAMazc/LecturaTemperatura/Alumno/0");
      client.subscribe("Gabanni/UAMazc/LecturaTemperatura/Profesor/0");
      client.subscribe("Gabanni/UAMazc/SinAcceso/0");
      client.subscribe("Gabanni/UAMazc/Despedida/0");
      client.subscribe("Gabanni/UAMazc/AforoLleno/0");
      client.subscribe("Gabanni/UAMazc/TemperaturaAlta/0");
      client.subscribe("Gabanni/UAMazc/DeshabilitadoTemperatura/Alumno/0");
      client.subscribe("Gabanni/UAMazc/DeshabilitadoTemperatura/Profesor/0");
      ...
      char out[128];
      int b = serializeJson(doc, out);  //Sereliarizamos el JSON para poderlo mandar por mqtt.
      client.publish("Gabanni/UAMazc/Ubicacion/0", out); //Publicamos en MQTT.
    } else {
